...
python3 ./mri/run_mri.py --nproc_per_node 6 --standalone --data_root /data/mri/data --tra_ratio 25 --val_ratio 10 --run_list 0 --model_type STCNNT_hrnet

python3 ./mri/run_mri.py --nproc_per_node 6 --standalone --data_root /data/mri/data --tra_ratio 25 --val_ratio 10 --run_list 0 --load_path /export/Lab-Xue/projects/mri/checkpoints/mri-HRNET-20230716_190117_960318_C-32-1_amp-False_complex_residual_weighted_loss-T1L1G1_T1L1G1T1L1G1_T1L1G1T1L1G1_T1L1G1T1L1G1_epoch-46.pth --run_extra_note second_stage_training --model_type MRI_hrnet --lr_pre 1e-6 --lr_backbone 1e-6 --lr_post 1e-4 --not_load_post --disable_pre --disable_backbone # --use_amp --save_samples --with_data_degrading --min_noise_level 12.0 --losses mse perpendicular psnr l1 gradient gradient3D ssim --loss_weights 0.1 1.0 1.0 1.0 20.0 20.0 2.0
