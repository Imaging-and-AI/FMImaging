...
python3 ./mri/run_mri.py --standalone --nproc_per_node 4 --min_noise_level 1.0 --max_noise_level 24.0 --losses mse perpendicular psnr l1 --loss_weights 1.0 1.0 1.0 1.0 --model_type STCNNT_MRI
