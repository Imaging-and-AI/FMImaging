...
python3 ./mri/run_mri.py --nproc_per_node 4 --nnodes 2 --node_rank 0 --rdzv_endpoint 172.16.0.4 --tra_ratio 25 --val_ratio 10 --run_list 0 --load_path /export/Lab-Xue/projects/mri/checkpoints/mri-HRNET-20230716_190117_960318_C-32-1_amp-False_complex_residual_weighted_loss-T1L1G1_T1L1G1T1L1G1_T1L1G1T1L1G1_T1L1G1T1L1G1_epoch-70.pth --model_type MRI_hrnet --lr_pre 1e-6 --lr_backbone 1e-6 --lr_post 1e-4 --not_load_post --disable_pre --disable_backbone --min_noise_level 1.0 --losses mse perpendicular psnr l1 gaussian gaussian3D ssim --loss_weights 0.1 1.0 1.0 1.0 20.0 20.0 2.0 --with_data_degrading --run_extra_note 2nd_stage_with_data_degrading_min_noise_1_backbone_trainable
