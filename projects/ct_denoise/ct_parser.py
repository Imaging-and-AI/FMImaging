"""
self.parser for the CT project
"""
...
class ct_parser(object):
    """
    CT self.parser for project specific arguments
    """

    def __init__(self):
        self.parser = argparse.ArgumentParser("Argument parser for STCNNT Mirco")

        self.parser.add_argument("--data_set", type=str, default="ct", help='general purpose argument')
        ...
        self.parser.add_argument("--ct_time", type=int, default=16, help='time points of the training images')
        self.parser.add_argument("--ct_height", nargs='+', type=int, default=[32, 64], help='heights of the training images')
        self.parser.add_argument("--ct_width", nargs='+', type=int, default=[32, 64], help='widths of the training images')
        self.parser.add_argument("--clean_name", type=str, default="SOC_AiCE", help='name of image to be used as ground truth (case insensitive)')
        ...
        # training
        self.parser.add_argument("--model_type", type=str, default="STCNNT_CT", help='"STCNNT_CT" or "STCNNT_double"')
