...
python3 ./projects/microscopy_denoise/microscopy_run_ddp.py --project microscopy \
    ...
    --train_files Medium_20_percent_300msec_train.h5 Low_7_percent_300msec_train.h5 --test_files Low_7_percent_300msec_test.h5 Medium_20_percent_300msec_test.h5 \
    ...
    --load_path $model \
    --global_lr 0.000025 --lr_pre  0.000025 --lr_backbone  0.000025 --lr_post  0.000025 \
    --train_samples 20000000 --run_extra_note FineTuning_Beads --no_clip_data --scheduler_type OneCycleLR --scaling_vals 0 1024
...
model=/isilon/lab-xue/projects/data/logs/microscopy-FineTuning_Beads_mse_l1_ssim_STCNNT_HRNET_T1L1G1T1L1G1_T1L1G1T1L1G1_20240320_213659_673545_STCNNT_Microscopy_C-64-1_amp-False_residual-T1L1G1T1L1G1_T1L1G1T1L1G1/last_epoch

python3 ./projects/microscopy_denoise/microscopy_inference.py --input_dir /export/ai-data/Beads for AI/Medium_20_percent_300msec/test/noisy/ --output_dir /export/ai-data/Beads for AI/Medium_20_percent_300msec/test/noisy/res --saved_model_path $model --image_order HWT --no_clip_data --batch_size 2 --patch_size_inference 64 --scaling_vals 0 1024 --cuda_devices 0 1 2 3 4 5 6 7
