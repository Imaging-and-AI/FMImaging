"""
Set up the metrics for microscopy
"""
...
# -------------------------------------------------------------------------------------------------
class MicroscopyMetricManager(MetricManager):
    """
    Metrics used for Microscopy
    """
    ...
    def parse_output(self, output):
        if self.config.model_type == "STCNNT_Microscopy" or self.config.model_type == "Microscopy_hrnet" or self.config.model_type == "omnivore_Microscopy":
