...
class run_ddp_base(object):
    ...
    def arg_parser(self):
        ...
        @args:
            - No args
        @rets:
            - parser (ArgumentParser): the argparse for torchrun of ct
        """
        parser = argparse.ArgumentParser(prog=self.project)

        parser.add_argument("--project", type=str, default="ct", help="project name")
        ...
        parser.add_argument("--wandb_dir", type=str, default='/export/Lab-Xue/projects/ct/wandb', help='directory for saving wandb')
    ...
    def run(self):
        ...
        os.environ["CUDA_VISIBLE_DEVICES"]=config.cuda_devices # TODO: proper setup
